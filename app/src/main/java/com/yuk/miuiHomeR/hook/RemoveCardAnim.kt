...
object RemoveCardAnim : BaseHook() {
    override fun init() {
        ...
        if (!mPrefsMap.getBoolean("recents_card_remove_anim")) return
        "com.miui.home.recents.views.SwipeHelperForRecents".hookAfterMethod("onTouchEvent", MotionEvent::class.java) {
            if (it.thisObject != null && it.thisObject.getObjectField("mCurrView") != null) {
        ...
        "com.miui.home.recents.TaskStackViewLayoutStyleHorizontal".replaceMethod(
            ...
            val dATVInterpolator =
                XposedHelpers.newInstance("com.miui.home.launcher.anim.PhysicBasedInterpolator".findClass(), 0.9f, 0.78f) as Interpolator
            ofFloat.interpolator = dATVInterpolator
            ofFloat.duration = 512L
