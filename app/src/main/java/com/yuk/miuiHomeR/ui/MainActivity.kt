...
class MainActivity : BaseAppCompatActivity() {
    ...
    private fun initData() {
        val mPreferenceChangeListener =
            OnSharedPreferenceChangeListener { sharedPreferences: SharedPreferences, s: String ->
                ...
                contentResolver.notifyChange(Uri.parse("content://" + SharedPrefsProvider.AUTHORITY + "/" + path + s),
                    null)
                if (path != "") contentResolver.notifyChange(Uri.parse("content://" + SharedPrefsProvider.AUTHORITY + "/pref/" + path + s),
                    null)
            }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        val state = packageManager.getComponentEnabledSetting(ComponentName(this,
