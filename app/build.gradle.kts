...
dependencies {
    ...
    implementation(files("libs/appcompat-release.aar"))
    implementation(files("libs/appcompat-resources-release.aar"))
    implementation(files("libs/blur-release.aar"))
    implementation(files("libs/core-release.aar"))
    implementation(files("libs/haptic-release.aar"))
    implementation(files("libs/internal-release.aar"))
    implementation(files("libs/os-release.aar"))
    implementation(files("libs/preference-release.aar"))
    implementation(files("libs/recyclerview-release.aar"))
    implementation(files("libs/smooth-release.aar"))
    implementation(files("libs/springback-release.aar"))
}
